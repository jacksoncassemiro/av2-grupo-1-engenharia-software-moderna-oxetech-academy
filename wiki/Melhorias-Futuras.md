...
A decisão de escopo está registrada em [ADR-008](ADR-008-Rebaseline-de-Escopo).
...
- **Por que saiu:** não consta no enunciado. O primeiro atendente é criado pelo seed idempotente
  ([ADR-004](ADR-004-Bootstrap-do-Atendente)), o que basta para a demonstração e para os
...
([ADR-008](ADR-008-Rebaseline-de-Escopo) §2). Uma US com backend pronto e sem tela não
