...
- Backlog priorizado ([`02`](Backlog-e-User-Stories)): US-00 a US-13 no formato *"Como… Quero… Para…"*
  com critérios de aceite em Gherkin.
- **Guardar o escopo.** Depois do rebaseline ([ADR-008](ADR-008-Rebaseline-de-Escopo)),
  pedido novo que não esteja no enunciado vai para
  [`15-melhorias-futuras.md`](Melhorias-Futuras), não para a sprint.
...
- **Backend e frontend são aplicações separadas** ([`03`](Arquitetura)). O MVC avaliado é
...
| 3 | Escopo do MVP: dentro / fora — e **por que** cortamos ([ADR-008](ADR-008-Rebaseline-de-Escopo)) |
