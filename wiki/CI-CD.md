...
Entregável de QA. Arquivo: [`.github/workflows/ci.yml`](https://github.com/jacksoncassemiro/av2-grupo-1-engenharia-software-moderna-oxetech-academy/blob/develop/.github/workflows/ci.yml).
...
check** na proteção de `main` e `develop` (ver [10-git-flow.md](Git-Flow) §2).
