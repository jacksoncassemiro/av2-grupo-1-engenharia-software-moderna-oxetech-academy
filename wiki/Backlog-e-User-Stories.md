...
> MF02 em [`15-melhorias-futuras.md`](Melhorias-Futuras). Justificativa completa no
...
Detalhes em [ADR-003](ADR-003-Autenticacao).
...
> [`15-melhorias-futuras.md`](Melhorias-Futuras). A **inativação** entrou no MVP pelo
...
> [`15-melhorias-futuras.md`](Melhorias-Futuras). O paciente atualiza os próprios
> dados na US-04.
- `[QA]` CT01, CT02, CT03
