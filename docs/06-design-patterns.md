...
>
> Contexto das duas aplicações: [`03-arquitetura.md`](03-arquitetura.md).
...
| **Compound Components** | `Table.Thead`, `List.Item` do Mantine | API declarativa. ⚠️ Não atravessa a fronteira RSC — ver [`03-arquitetura.md`](03-arquitetura.md) §3.3 |
