...
**Removido do MVP e registrado em [`15-melhorias-futuras.md`](../15-melhorias-futuras.md):**
...
|---|---|
| [`03-arquitetura.md`](../03-arquitetura.md) | §2 é o MVC do backend; §3 é a arquitetura de componentes do frontend; §4 é o contrato de integração. A "View" do MVC passa a ser a camada de schemas Pydantic, não o app React |
| [`05-clean-code.md`](../05-clean-code.md) | Cada uma das 3 práticas exigidas é demonstrada **nas duas stacks**, com exemplo ruim/bom em Python e em TypeScript |
| [`06-design-patterns.md`](../06-design-patterns.md) | Strategy e Repository são declarados explicitamente como padrões **do backend**. O que o frontend usa aparece em seção própria, sem competir pela contagem |
| [`07-plano-de-testes.md`](../07-plano-de-testes.md) e [`08-casos-de-teste.md`](../08-casos-de-teste.md) | Testes unitários separados por stack: pytest no backend, Vitest no frontend, com contagem própria |
