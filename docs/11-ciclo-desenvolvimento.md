...
[14-conflitos-e-decisoes.md](14-conflitos-e-decisoes.md)), prazo até 10/08 (11 dias corridos), equipe com
...
|---|---|---|
| Product Owner | Jackson (dono do backlog) · Antonio (PO de apoio, conduz cerimônias) | Divisão registrada em [13](13-papeis-e-responsabilidades.md) |
| Scrum Master | Antonio | Acumula, dado o tamanho da equipe (7 pessoas) |
| Developers | Ronaldo (backend) · João Vitor e Antonio (frontend) · Uanderson, Felipe e Alyssandro (QA) | No Scrum, "Developers" inclui QA |
...
> segundas, quartas, sextas e sábados. Detalhe dia a dia em [`12-cronograma.md`](12-cronograma.md).

### Sprint 1 — Planning (kickoff)

- **Data:** 31/07 (sexta) · **Participantes:**
- **Pauta obrigatória:** apresentar o rebaseline de escopo ([ADR-008](adr/ADR-008-rebaseline-escopo.md))
